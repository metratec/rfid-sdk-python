...
class RfidReader(BaseClass):
    ...
    async def fetch_inventory(self, wait_for_tags: bool = False) -> List[Tag]:
        ...
        Returns:
            List[Tag]: a list with the founded transponder
        """
        async with self._inventory_condition:
            if wait_for_tags:
    ...
    def is_connected(self) -> bool:
        ...
        Returns:
            bool: connected
        """
        return self.get_connection().is_connected()

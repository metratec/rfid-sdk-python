...
class UhfTagTestCase(unittest.TestCase):
    ...
    def test_zero(self) -> None:
        ...
        self.assertEqual(0, tag.get_timestamp())  # deprecated
        self.assertEqual(0, tag.get_first_seen())
        self.assertEqual(0, tag.get_last_seen())
    ...
    def test_init(self) -> None:
        ...
        self.assertEqual(tag.get_timestamp(), timestamp)  # deprecated
